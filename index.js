...
// searches chats
 var searchMessage = () => {
    val = messageSearch.value.toLowerCase();
    message.forEach(user => {
        var name = user.querySelectorAll('h5').textContent.toLowerCase();
...
Bg1.addEventListener('click', () => {
    ...
    // remove actvie class from others
